...
//
`define     SW  6'b101011  //  store word (I 形式) op=43
//
//
//
...
//
  assign  ram_write_enable = ((op_code == `SW) && 1'b1) ? 1'b1 : 1'b0;
//
//
//
...
//
      `ADDIU:  is_branch_ctrl_tmp = 3'b110; //do nothing
//
//
//
...
//
  assign  jp = (((op_code == `J) && 1'b1) || ((op_code == `JAL) && 0)) ? 1'b1 : 1'b0;
//
//
//
//
...
//
      `J:      reg_write_enable_tmp = 1'b0; //書き込みを行わない
//
//
//
...
//
      `ADDIU:  alu_ram_sel_s_tmp = 1'b0; //ALUからのデータ
//
//
//
