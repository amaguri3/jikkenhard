...
//
//追加設計 2 のヒント(1)：jp_sel の入出力用ワイヤの宣言→コメントアウトを外した
//
...
//
  assign pc_next = jp_sel_y;//pc_nextに接続
  //assign pc_next = pc_sel_y; //古い接続を切断
...
//
//追加設計 2 ヒント(4)：jp_sel の入力 jp_sel_d0, jp_sel_d1, jp_sel_s の接続→コメントアウト外した
//
